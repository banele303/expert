      ...
      <section className="relative pt-40 pb-20 overflow-hidden bg-[#F8F9FB]">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            >
              ~Spares City is South Africa&apos;s premier retail supplier, bridging the gap between <span className="text-slate-900 not-italic font-bold">industrial excellence</span> and consumer convenience.
            </motion.p>
          </motion.div>
        </div>
      </section>
           ...
           <div className="grid lg:grid-cols-2 gap-24 items-center">
              ...
              >
                 ...
                 <p className="text-xl text-slate-500 font-medium leading-relaxed italic">
                   Founded on a vision of uncompromising quality and technical reliability, ~Spares City has evolved from a local Bramley store into a nationwide logistics powerhouse for automotive components.
                 </p>
              ...
              <div className="relative">
                 <div className="relative rounded-[60px] overflow-hidden shadow-2xl shadow-black/10 border-[12px] border-white rotate-[-3deg] z-10">
                    <NextImage 
                      src="https://images.unsplash.com/photo-1506161911718-d5a2f50fbe76?q=80&w=1000&auto=format&fit=crop" 
                      alt="Operations" 
                      width={600} 
                      height={800} 
      ...
      <section className="py-32 bg-[#F8F9FB] rounded-[60px] mx-6">
        <div className="container mx-auto px-6">
          <div className="text-center mb-24 max-w-3xl mx-auto">
             ...
             <p className="text-xl text-slate-500 font-medium italic">Defined by three core tenets that govern every transaction in our Bramley warehouse.</p>
          </div>
           ...
           <div className="relative bg-slate-900 p-16 lg:p-32 rounded-[60px] overflow-hidden text-center max-w-6xl mx-auto">
              ...
              >
                 <h2 className="text-5xl md:text-[80px] font-black tracking-tighter text-white mb-12 leading-none uppercase">
                   JOIN THE <span className="text-primary italic">~SPARES CITY</span> ERA.
                 </h2>
