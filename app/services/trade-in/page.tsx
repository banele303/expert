...
const benefits = [
  {
    ...
    description: "Get the best market value for your current vehicle",
  },
  {
    icon: Clock,
    title: "Quick Process",
    description: "Fast assessment and immediate valuation",
  },
  {
    icon: TrendingUp,
    title: "Towards Purchase",
    description: "Use your trade-in value as deposit on your new car",
  },
  {
    icon: Award,
    title: "No Obligation",
    description: "Free quotes with no pressure to accept",
  },
];
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            >
              Looking to upgrade? We offer fair trade-in values for your current vehicle. Get a competitive offer and make the upgrade process seamless.
            </motion.p>
            <motion.div
              variants={fadeInUp}
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-background to-[oklch(0.1_0.01_260)]">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              Trade-In <span className="gradient-text">Benefits</span>
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-lg text-muted-foreground max-w-2xl mx-auto"
            >
              Make upgrading to your new car easier with our trade-in service
            </motion.p>
          </motion.div>
              ...
              {[
                {
                  step: "01",
                  title: "Contact Us",
                  description: "Get in touch with details about your current vehicle",
                },
                {
                  step: "02",
                  title: "Vehicle Assessment",
                  description: "We inspect your car and review its condition and history",
                },
                {
                  step: "03",
                  title: "Receive Offer",
                  description: "Get a fair market valuation with no obligation to accept",
                },
                {
                  step: "04",
                  title: "Trade & Upgrade",
                  description: "Use the value towards your new vehicle purchase",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
            ...
            >
              <div className="grid md:grid-cols-2 gap-4">
                {[
                  ...
                  "Outstanding finance details (if any)",
                ].map((item, index) => (
