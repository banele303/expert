      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-32 border-b border-slate-100 pb-24">
          {[
            ...
            { icon: Settings, title: "Expert Support", desc: "Direct technical advice from SPARES CITY team" },
          ].map((item, idx) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-8 mb-24">
          ...
          {/* Contact Column */}
          <div className="lg:col-span-4">
            <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-slate-300 mb-10">Bramley HQ</h4>
            <div className="space-y-8">
              <div className="flex gap-6 items-start">
                ...
                <div>
                  <p className="text-slate-900 font-bold leading-tight italic">
                    593 Louis Botha Ave, Bramley<br />
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  <Link href="tel:+27829624108" className="text-slate-900 font-bold block mb-1">082 962 4108</Link>
                  <Link href="mailto:sales@sparescity.co.za" className="text-slate-400 font-bold italic text-sm">sales@sparescity.co.za</Link>
                </div>
              </div>
              <div className="flex gap-6 items-start">
                <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center shrink-0">
                ...
                <div>
                  <p className="text-slate-900 font-bold uppercase tracking-widest text-[10px]">Mon - Fri: 08:30 - 17:30</p>
                  <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px] mt-1">Sat: 08:30 - 13:00</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="pt-12 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-8">
          <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px]">
             © {new Date().getFullYear()} ~SPARES CITY. ALL RIGHTS RESERVED.
          </p>
